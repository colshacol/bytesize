export const MOCK_SOURCE = `# remmy

### \`npm i -g remmy\`

_This is just some placeholder bullshit for the Instruction Panel._
...
can be deep, as long as they are not \_infinitely\_ deep. Anywhere in your files,
